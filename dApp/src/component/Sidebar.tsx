        ...
        <div className="w-64 px-3 h-screen bg-white border-r border-gray-200 fixed left-0 top-0 flex flex-col z-50">
            ...
            <div className="p-4 border-t border-gray-100">
                <button 
                    ...
                    className="cursor-pointer flex w-full items-center justify-center gap-2 bg-red-50 text-red-600 px-4 py-3 rounded-xl hover:bg-red-100 transition-colors font-semibold"
                >
                    <LogOut size={18} />
                    Disconnect
                </button>
